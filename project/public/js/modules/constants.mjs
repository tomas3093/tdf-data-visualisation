...
export const UNKNOWN_NATION_MARK = 'Unknown';
...
// Converts ISO code of country to full name of the country
export function isoCodeToName(isoCode) {
    let decoder = new Map(
        [
            ['AF','Afghanistan'],
            ['AX','Åland Islands'],
    ...
    if (decoder.get(isoCode) == undefined) {
        return UNKNOWN_NATION_MARK;
    } else {
        return decoder.get(isoCode);
    }
}